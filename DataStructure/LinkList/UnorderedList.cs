...
namespace LinkList
{
    class UnorderedList
    {
        ...
        {
            string text = File.ReadAllText(@"C:\Users\DEEPAK\OneDrive\Desktop\rfp-161\PRATICE_PROBLEM\16-17DS\ConsoleApp1\LinkList\inputText.txt", Encoding.UTF8);
            ...
            File.WriteAllText(@"C:\Users\DEEPAK\OneDrive\Desktop\rfp-161\PRATICE_PROBLEM\16-17DS\ConsoleApp1\LinkList\inputText.txt", textFile);
